...
const Nav = () => {
  return (
    <div className="flex px-10 py-6 border-b-[1px] dark:border-b-[#ffffff1a] border-b-[#00000033] justify-between items-center">
      <h2 className="dark:text-white text-black text-3xl ">Hilda</h2>
